 ...
 *
 * The scope is checked as well as the targets, for the one narrowing that would
 ...
 * nothing. The release step's project list comes from the resolve step that also
