...
35 bits is 34,359,738,368 values. The birthday bound, not the size of the space,
is what decides when two codes collide:
...
The retry loop belongs here because the database is the only participant that
knows what has been issued.
