...
Everything the renderer puts around a widget is configurable, and everything a
widget should not know about itself is kept out of its props. This page is the
three seams that do that.
