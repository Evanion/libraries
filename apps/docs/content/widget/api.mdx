...
[the Overview](/widget#how-a-widget-item-array-describes-a-page) teaches the
item shape and [What it reports](/widget/problems) carries the message
catalogue, and this page links to them rather than teaching either again.
...
This is the seam between the core and a renderer. A consumer has no reason to
call it, and neither renderer re-exports it.
[What a widget renderer prints](/widget/problems#what-a-widget-renderer-prints-when-validateitems-never-ran)
...
renderer on
[What it reports](/widget/problems#what-a-widget-renderer-prints-when-validateitems-never-ran)
...
on [What it reports](/widget/problems).
...
offers a checked counterpart, and [`@evanion/react-widget`](/react-widget)'s
...
The `meta` vocabulary of a widget set whose chrome declares none. Any object,
...
beside a registry so that a webhook handler or a CI script validates a payload
