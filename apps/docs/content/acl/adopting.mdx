...
**The concept.** `parseMatrix` builds an evaluator over a foreign document.
**What you get.** An evaluator that refuses unknown keys.
**Why you want it.** Rewritten rules drift.
**How the library gets you there.** `parseMatrix` validates the document and
runs closed.
