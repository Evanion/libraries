...
**What you get.** A view that sends each question to the one origin whose keys
carry it.
...
**How the library gets you there.** Each origin namespaces its object kinds, and
the view routes on the namespaced key.
