...
export interface Access {
  ...
  authorize(subject: Subject, options?: { now?: Date }): Authorized;
...
export interface Policy<Sub, R> {
  ...
  capabilities(subject: Sub, now?: Date): Record<string, Decision>;
  authorize(subject: Sub, options?: { now?: Date }): Authorized;
...
export interface BoundKind<Sub, Obj> {
  can(subject: Sub, action: string, object?: Obj, now?: Date): Decision;
  canMany(
    subject: Sub,
    action: string,
...
export function policy<Sub>(
  ...
  const self = {
    ...
    capabilities: (subject: Subject, now?: Date) =>
      access().capabilities(subject, now),
    authorize: (subject: Subject, opts?: { now?: Date }) =>
