...
it. The five-step precedence order is the whole engine and is defined once, here:
...
4. a rule could not be decided for lack of an instance → `unevaluable`
5. otherwise → `no-rule-matched`
...
/** Steps 3, 4 and 5 of the precedence order, in that order. */
